...
const dramaScenes = {
  ...
  4: [
    { no: "4", title: "한 장", lines: [
        ...
        "민준: (고개도 안 들고) I know.",
        "삼돌이: (못난이를 힐끗 보며) Your words?",
        "못난이: (화들짝) I... yes.",
        "삼돌이: (한 박자 있다가, 주머니에서 접은 종이를 꺼내 못난이 책상 위에 올려놓으며) ...Keep it.",
  ...
  5: [
    { no: "5", title: "나는 사랑해 너를", lines: [
        "[동아리실. 첫 합동 연습.]",
        "민준: (지휘봉 같은 펜을 들고) You dance. She writes. I plan.",
        "삼돌이: (벽에 삐딱하게 기대어) I dance alone.",
        "민준: (단호하게) One week. Try it.",
  ...
  9: [
    { no: "9", title: "뜻 없는 연결", lines: [
        ...
        "민준: (애써 덤덤한 척) And?",
        "삼돌이: (고개를 들며 씩 웃는다) I'm here.",
        "(못난이, 활짝 웃는다. 삼돌이는 쑥스러운 듯 헛기침하며 거울 쪽으로 고개를 돌린다.)",
        "민준: (입가에 번지는 미소를 숨기며 크게 소리친다) Music start!"
      ] }
  ],
  10: [
  ...
  13: [
    { no: "13", title: "결과만 보이는", lines: [
        ...
        "삼돌이: (음악을 탁 끄며) The second part. It's different.",
        "민준: I changed it.",
        "삼돌이: Without asking?",
        "민준: It flows better.",
        "삼돌이: It was my move.",
  ...
  14: [
    { no: "14", title: "그때는 그랬어", lines: [
        "[연습실. 공연 이틀 전.]",
        "(습기로 거울이 뿌옇다. 세 사람 모두 예민함이 극에 달했다.)",
        "삼돌이: The ending doesn't work!",
        "민준: We practiced it fifty times!",
        "삼돌이: It was wrong fifty times!",
        "못난이: Guys, maybe we change—",
        "민준: (말 끊으며) No time!",
        "삼돌이: Because you planned too tight!",
        "민준: I planned because nobody else did!",
        "못난이: (비명 지르듯) Stop!",
        "(둘, 숨을 헐떡이며 못난이를 본다.)",
        "못난이: We were fine yesterday.",
        "(침묵. 에어컨 소리만 윙윙거린다.)",
        "민준: (머리를 헝클어뜨리며) We're scared. That's what happened.",
        "삼돌이: (바닥을 툭툭 차며 기어들어 가는 목소리로) ...Me too.",
        "못난이: (분위기 풀려 풋 웃으며) Me three."
      ] }
  ],
  15: [
    { no: "15", title: "be동사 총정리", lines: [
        "[연습실. 공연 하루 전.]",
  ...
  16: [
    { no: "16", title: "모든 걸 가진", lines: [
        ...
        "못난이: (걸레질을 멈추고) I have a lot to say. But I can't say it loud.",
        "민준: So you write it down.",
        "못난이: Yes.",
        "민준: Does it help?",
        "못난이: Sometimes.",
  ...
  17: [
    { no: "17", title: "경험을 갖고 있는 상태", lines: [
        "[학교 옥상. 노을.]",
        "(삼돌이가 난간에 기대 밖을 보고 있다. 끼익, 문이 열리고 못난이가 온다.)",
        "못난이: Why do you always transfer?",
        "삼돌이: My mom's job.",
        "못난이: Have you ever stayed?",
        "삼돌이: No.",
        "못난이: Have you ever wanted to?",
        "(삼돌이, 바람에 날리는 머리칼을 넘기며 씁쓸하게 웃는다.)",
        "삼돌이: Once. A long time ago.",
        "못난이: What happened?",
        "삼돌이: I left anyway.",
        "못난이: Did you regret it?",
        "삼돌이: (시선을 멀리 둔 채) I've thought about it. Every day since."
      ] }
  ],
  18: [
    { no: "18", title: "해야 할 이유", lines: [
        "[동아리실. 아침.]",
        "(아침 햇살. 못난이가 책상에 엎드려 자고 있다. 얼굴엔 볼펜 자국. 민준이 조심스레 들어오다 노트를 본다.)",
        "민준: (조그맣게) Have you been here all night?",
        "못난이: (부스스 깨며) I had to finish it.",
        "(민준, 노트를 들고 가사를 찬찬히 읽어 내려간다. 눈빛이 흔들린다.)",
        "민준: This is it.",
        "못난이: Is it okay?",
        "민준: We have to use this.",
        "못난이: You have to ask 삼돌이 too.",
        "민준: She'll say yes.",
        "못난이: (검지손가락 흔들며) You have to ask.",
        "(민준, 못 이기겠다는 듯 픽 웃으며 고개를 끄덕인다.)"
      ] }
  ],
  19: [
    { no: "19", title: "가려고 하는 중", lines: [
        "[동아리실. 텅 빈 방.]",
        "(못난이, 노트에 펜슬로 적는다. \"I'm sorry. I don't belong here.\" 눈물이 툭 떨어진다. 그때 덜컥 문이 열리고 민준이 들어온다. 못난이, 황급히 노트를 덮는다.)",
        "민준: You okay?",
        "못난이: (눈물 훔치며) I was going to leave a note.",
        "민준: Why?",
  ...
  20: [
    { no: "20", title: "재미를 가져", lines: [
        "[연습실. 오후.]",
        "(비트가 빠른 음악. 셋이 군무를 맞춘다. 삼돌이가 장난기가 발동해 예정에 없던 현란한 웨이브를 넣는다. 못난이가 엉거주춤 따라 하다가 자기 발에 걸려 '꽈당' 넘어진다.)",
        "삼돌이: (화들짝) Are you okay?!",
        "못난이: (바닥에 납작 엎드린 채 엄지만 치켜든다) I'm good.",
        "민준: (뒤돌아서 어깨를 파르르 떨며 웃음을 참는다)",
        "(못난이, 벌떡 일어나 다시 춤추다 또 미끄러진다.)",
        "삼돌이: (결국 배를 잡고 뒹군다)",
        "민준: (바닥을 치며 박장대소한다)",
  ...
  21: [
    { no: "21", title: "받는 순간", lines: [
        ...
        "못난이: Oh, it's fine.",
        "삼돌이: (멈추며) No. It's not fine. I mean— (헛기침) I got your words.",
        "못난이: What?",
        "삼돌이: What you said. \"She comes back. That's the ending I want.\"",
        "못난이: (조용히) Yeah.",
        "삼돌이: Nobody ever... (말을 고르다가) I got it. That's all.",
        "(못난이, 동그란 눈으로 쳐다본다.)",
  ...
  23: [
    { no: "23", title: "셋의 차이", lines: [
        ...
        "삼돌이: I got the moves. You have the words. He has the structure.",
        "못난이: Is that enough?",
        "삼돌이: It has to be.",
        "민준: It is.",
        "(정적. 거울 속 자신들을 본다.)",
  ...
  25: [
    { no: "25", title: "마음이 향해", lines: [
        ...
        "못난이: I know where she is.",
        "민준: How?",
        "못난이: I just know.",
        "민준: (결연하게 고개 끄덕이며) Go. I'll wait here."
      ] }
  ],
  26: [
    { no: "26", title: "하려고 vs 해보니", lines: [
        ...
        "못난이: (숨 헐떡이며) I looked everywhere!",
        "삼돌이: I needed air.",
  ...
  29: [
    { no: "29", title: "정확한 그 점", lines: [
        "[무대 위. 공연 중.]",
        "(조명 폭발. 비트에 맞춘 완벽한 칼군무. 관객들 환호성. 완벽하게 흘러가던 중, 브릿지 파트. 민준이 다시 한번 10화 때와 같은 위치에서 삐끗하며 밸런스를 잃는다. 음악은 흐르는데 민준의 몸이 0.5초 굳어버린다. 관객석에서 '어?' 하는 공기 흐름이 느껴진다.)"
      ] },
    { no: "29.5", title: "못난이의 순간", lines: [
        ...
        "(그 사이 민준과 삼돌이, 대형 재정비 완료. 비트가 다시 터진다. 관객 환호.)",
        "(무대 뒤. 삼돌이가 못난이를 본다.)",
